                                ...
                                (async function () {
                                    try {
                                        ...
                                        console.log('=======id=======' +id);
                                            ...
                                            bodyletter.cust = record.CUSTNUMBER;
                                            bodyletter.acc = record.ACCNUMBER;
                                            bodyletter.custname = record.CLIENT_NAME;
                                            bodyletter.address = record.ADDRESS;
                                            bodyletter.telnumber= record.TELNUMBER,
                                            bodyletter.postcode = record.POSTALCODE;
                                            bodyletter.arocode = record.AROCODE;
                                            bodyletter.branchname = record.BRANCHNAME;
                                            bodyletter.branchcode = record.BRANCHCODE;
                                            bodyletter.manager = record.BRANCHMANAGER;
                                            bodyletter.customeremail = record.EMAILADDRESS;
                                            bodyletter.ccy = record.CURRENCY;
                                            bodyletter.demand1date = new Date();
                                            bodyletter.oustbalance = record.OUSTBALANCE;

                                            const acc_resp = await axios.get(dbConfig.API + '/api/loans_finacles?filter[where][custnumber]=' + record.CUSTNUMBER);
